LD.ConfluenceActions=
{
	...
	retrieveBody: function(specification, implemented){ this.query("body", specification.params.ctx + "/livingdoc/RetrieveBody.action", specification, {implemented:implemented}); },
	...
	{ 
		...
		AJS.$.ajax({
			...
			timeout: obj.params.maxResponseTime,
